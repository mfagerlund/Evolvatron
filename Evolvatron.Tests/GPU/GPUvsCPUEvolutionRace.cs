...
public class GPUvsCPUEvolutionRace
{
    ...
    public void RaceGPUvsCPU()
    {
        ...
        // --- GPU Evolution ---
        _output.WriteLine("=== GPU Evolution ===");
        var gpuTrace = RunGPUEvolution(topology, gpuPopSize, maxSteps, timeBudgetSeconds, evalRounds);
...
<p class=""subtitle"">Rocket Landing (Hard: 8-15m, &plusmn;25&deg;, 130N, 3-seed avg) &middot; {timeBudget}s wall time &middot; GPU {gpuPop:N0} pop vs CPU {cpuPop:N0} pop</p>
